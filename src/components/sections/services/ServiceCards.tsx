...
const iconPaths = [
  ...
  'M21.75 6.75a4.5 4.5 0 01-4.884 4.484c-1.076-.091-2.264.071-2.95.904l-7.152 8.684a2.548 2.548 0 11-3.586-3.586l8.684-7.152c.833-.686.995-1.874.904-2.95a4.5 4.5 0 016.336-4.486l-3.276 3.276a2.25 2.25 0 002.25 2.25l3.276-3.276c.256.565.398 1.192.398 1.852z',
];
...
export function ServiceCards() {
  return (
    <Section variant="navy">
      <Container>
        <SectionHeading
          overline={services.offerings.overline}
          heading={services.offerings.heading}
          dark
          align="center"
        />
